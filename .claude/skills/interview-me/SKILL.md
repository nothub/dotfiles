---
name: interview-me
description: Extract what the user actually wants via one-question-at-a-time interviews. Use when a request is underspecified, or before any plan, spec, or code exists. Triggers on 'interview me'.
---
