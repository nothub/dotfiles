...
description: Break work into ordered, verifiable tasks. Use when a spec exists and needs tasks, when scope is unclear, or when work can be done in parallel.
---
