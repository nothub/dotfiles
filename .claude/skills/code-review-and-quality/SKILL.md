...
- formatLegacyDate() in internal/format/date.go — replaced by formatDate()
- legacyTaskStore in internal/task/store.go — replaced by taskStore
...
4. Does it have known vulnerabilities? (`govulncheck ./...`)
...
- **Pair:** `code-simplification` — if the review surfaces unnecessary complexity
