...
Implementation patterns for separating input/output types, typed IDs, and consumer-side interfaces live in `references/go-interface-patterns.md` — read it when defining new Go interfaces or types.
